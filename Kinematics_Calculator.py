...
def ConstantAcceleration():
    ...
    while True:
        ...
        elif p_i in Kinematic.Unknown:
            answer = None
            if all(x in Kinematic.Given for x in [p_i, v_i, v_f, t]):
                equation = Kinematic.Equation[4]
